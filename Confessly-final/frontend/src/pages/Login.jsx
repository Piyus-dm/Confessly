            ...
            <main className="auth-container">
                ...
                <form className="auth-form" onSubmit={handleSubmit} autoComplete="off">
                    ...
                    <button
                        ...
                        disabled={submitting || !email || !password || !captcha}
                    >
                        {submitting ? 'Signing in…' : !captcha ? 'Verifying you’re human…' : 'Sign In'}
                    </button>

                    <p style={{ textAlign: 'center', marginTop: 10 }}>
                        <Link to="/forgot-password" style={{ color: '#888', fontSize: '0.78rem' }}>Forgot password?</Link>
                    </p>
                </form>
